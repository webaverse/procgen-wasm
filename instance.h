...
public:
    ...
    void getComputedMaterials(Heightfield &localHeightfield, std::unordered_map<uint8_t, MaterialCountWeightPair> &materialsCounts, float &totalMaterialFactors, const vm::vec2 &worldPosition);
