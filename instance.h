...
public:
    ...
    void getComputedMaterials(Heightfield &localHeightfield, std::vector<MaterialCountWeightPair> &materialsCounts, float &totalMaterialFactors, const vm::vec2 &worldPosition);
