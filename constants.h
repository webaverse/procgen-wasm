...
constexpr float GRASS_THRESHOLD = 0.01f;
constexpr int MAX_NUM_VEGGIES_PER_CHUNK = 8;
constexpr float VEGGIE_THRESHOLD = 0.15f;
constexpr float OCEAN_THRESHOLD = 0.5f;
constexpr float STONE_THRESHOLD = 0.3f;
...
constexpr float GRASS_HEIGHT_VARIATION_RANGE = 0.5f;
constexpr float GRASS_COLOR_VARIATION_BASE = 0.85f;
constexpr float GRASS_COLOR_VARIATION_RANGE = 0.3f;
constexpr float CRUSHED_GRASS_THRESHOLD = 1.f - STONE_THRESHOLD;
