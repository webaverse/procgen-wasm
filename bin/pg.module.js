...
var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 524288000;legacyModuleProp('INITIAL_MEMORY', 'INITIAL_MEMORY');
...
var ASM_CONSTS = {
  26732: ($0) => { console.log('Leaked Size: ', $0); },  
 26770: ($0) => { console.log(UTF8ToString($0)); },  
 26805: () => { console.log("MemoryManager Init"); },  
 26840: ($0) => { console.log('Clean it up babe : ', $0); },  
 26880: ($0, $1) => { handleResult($0, $1); }
};
...
/** @type {function(...*):?} */
var _createChunkMeshAsync = Module["_createChunkMeshAsync"] = createExportWrapper("createChunkMeshAsync");

/** @type {function(...*):?} */
var _createBarrierMeshAsync = Module["_createBarrierMeshAsync"] = createExportWrapper("createBarrierMeshAsync");
...
/** @type {function(...*):?} */
var _setCamera = Module["_setCamera"] = createExportWrapper("setCamera");
...
/** @type {function(...*):?} */
var _getMemoryLeak = Module["_getMemoryLeak"] = createExportWrapper("getMemoryLeak");
